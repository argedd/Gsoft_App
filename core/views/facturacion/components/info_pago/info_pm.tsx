...
const InfoPmComponent = () => {
  ...
  return (
        <View>
             <Text style={[styles.datosDelPago, styles.textTypo]}>Datos del pago móvil</Text>
          <View style={styles.frameGroup}>
            <View style={styles.nDeTelefonoParent}>
              <Text style={[styles.nDeTelefono, styles.bsTypo]}>Nº de telefono:</Text>
              <Text style={[styles.text, styles.textTypo]}>{bankAssociated.tlf}</Text>
            </View>
            ...
            <View style={styles.bankParent}>
              ...
              <Text style={[styles.text, styles.textTypo]}>{bankAssociated.nro_cta.substring(0, 4)} {bankAssociated.bank_name}</Text>
            </View>
          </View>
          <View style={styles.frameGroup}>
...
export default InfoPmComponent;
